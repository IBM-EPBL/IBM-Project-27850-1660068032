...
#define ORG "k1o3f1"//IBM ORGANITION ID
...
/*.....................................retrieving to 
Cloud...............................*/
void PublishData(float temp, float humid,float status) {
...
initManagedDevice();
client.subscribe("cmnd/command/motoron");
...
Serial.print(client.subscribe(subscribetopic));
callback(subscribetopic,0,1);
